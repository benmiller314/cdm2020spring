...
<figure>
<img src="{{site.github.baseurl}}/assets/img/2019fall-seating-groups.png" alt="Alex, Brittany, Richard, and Weston / Corey, Danielle, Ellie, and Rebecca / Emma M, Jade, and Julianna / Fatema Q, Natasha, Rachel, and Ruhi / Emma K, Fathima S, Kevin, and Nicole">
</figure>
...
* **Push** a full draft, with the same four parts as the preview *plus* a CREDITS.md file with citations for the sources you've actually used (including direct links where possible) and permissions/license to use them <!-- NOTE FOR NEXT TIME: Remind them that they don't have to change the name of the project, and in fact they probably shouldn't! -->
